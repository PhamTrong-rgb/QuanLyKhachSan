...
<<<<<<< HEAD
            {room.status === "Sẵn sàng" ? (
              ...
              <span className="neo-button px-5 py-3 rounded-xl bg-red-50 text-red-600 border border-red-200 font-bold flex items-center justify-center cursor-not-allowed">
                Không thể đặt
              </span>
            )}
